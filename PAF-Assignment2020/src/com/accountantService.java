...
//insert
	...
	public String insertItem(@FormParam("Acode") String Acode, @FormParam("AName") String AName,
			@FormParam("ANIC") String ANIC, @FormParam("PhoneNo") String PhoneNo, @FormParam("Email") String Email,
