...
public class pharmacistService {
	...
	public String insertItem(@FormParam("Pcode") String Pcode, @FormParam("PName") String PName,
			@FormParam("PNIC") String PNIC, @FormParam("PhoneNo") String PhoneNo, @FormParam("Email") String Email,
