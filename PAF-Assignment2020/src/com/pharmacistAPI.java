...
public class pharmacistAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// TODO Auto-generated method stub
		String output = phobj.insertItem(request.getParameter("Pcode"), request.getParameter("PName"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String output = phobj.updateItem(paras.get("hidItemIDSave").toString(), paras.get("Pcode").toString(),
				paras.get("PName").toString(), paras.get("PNIC").toString(), paras.get("PhoneNo").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response)
		...
		String output = phobj.deleteItem(paras.get("PID").toString());
