...
public class doctorAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String output = itemObj.insertItem(request.getParameter("DocLNo"), request.getParameter("Name"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = itemObj.updateItem(paras.get("hidItemIDSave").toString(), paras.get("DocLNo").toString(),
				paras.get("Name").toString(), paras.get("NIC").toString(), paras.get("PhoneNo").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = itemObj.deleteItem(paras.get("DocID").toString());
